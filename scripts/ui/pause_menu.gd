...
@onready var quit_to_main_menu_button: Button = $MarginContainer/VBoxContainer/QuitToMainMenuButton
@onready var quit_to_desktop_button: Button = $MarginContainer/VBoxContainer/QuitToDesktopButton
